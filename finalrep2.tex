...
\begin{figure*}
  ...
  \label{fig:quad}
\end{figure*} 
Figure \ref{fig:quad} depicts the ideal action to be taken for the state space covered by [$\theta ,\psi_f$]. This ideal action is the action which minimises the distance or angle moved in that direction to return the unicycle to the desired position of [$\theta ,\psi_f$] = [0,0]. 
\newline
